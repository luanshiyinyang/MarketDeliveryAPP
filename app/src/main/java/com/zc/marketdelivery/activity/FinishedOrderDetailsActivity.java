...
public class FinishedOrderDetailsActivity extends AppCompatActivity {
    ...
    private void bindViews() {
        ...
        rv_order_detail_shops_detail = (RecyclerView) findViewById(R.id.rv_order_detail_goodss_detail);
    ...
    private void initViews() {
        ...
        tv_order_detail_expectTime.setText(order.getTimeExpected());
        tv_order_detail_arriveTime.setText(order.getTimeArrived());
        tv_order_detail_address.setText(order.getAddress());
