...
import com.zc.marketdelivery.adapter.HistoryAdapter;
import com.zc.marketdelivery.adapter.SearchAdapter;
import com.zc.marketdelivery.utils.StringUtil;
...
public class HomeSearchActivity extends AppCompatActivity {
    ...
    private void initData() {
        ...
        listSearch.add("欧尚超市1");
        listSearch.add("欧尚超市2");
        listSearch.add("欧尚超市3");
        listSearch.add("zc");
    }
    ...
    public void init(){
        ...
        mResultAdapter = new SearchAdapter(HomeSearchActivity.this, listResult);
    ...
    private void initHistory(){
        ...
        mHistoryAdapter = new HistoryAdapter(HomeSearchActivity.this,history);
    ...
    private void search(String newText){
        ...
        if(newText.isEmpty()){
            ...
            for (String note : listSearch) {//开始搜索

                //搜索内容搜索到相关
                if (note.contains(newText) || note.contains(newText)) {
